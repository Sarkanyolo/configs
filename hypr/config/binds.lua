...
hl.bind(mainMod .. " + H",          hl.dsp.exec_cmd(launchPrefix .. EDITOR))
...
-- Move active window to adjacent workspaces on the same monitor
hl.bind(mainMod .. " + N", hl.dsp.window.move({ workspace = "m+1" }))
hl.bind(mainMod .. " + P", hl.dsp.window.move({ workspace = "m-1" }))
